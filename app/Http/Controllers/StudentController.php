...
use Illuminate\Support\Facades\DB; // Added for signatories
use Carbon\Carbon;
...
class StudentController extends Controller
{
    ...
    public function createAccount(Request $request)
    {
        ...
        StudentIdentity::where('lrn', $request->lrn)->update(['is_active' => 1]);
    ...
    public function dashboard(Request $request, $lrn)
    {
        ...
        $query = Grade::where('lrn', $lrn)->where('is_published', 1);
        ...
        // FETCH SIGNATORIES FOR DASHBOARD VIEW IF NEEDED
        $signatories = (object)[
